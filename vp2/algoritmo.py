...
g.adiciona_aresta(2, 3, 8)
g.adiciona_aresta(2, 4, 9)
g.adiciona_aresta(2, 5, 7)
g.adiciona_aresta(3, 5, 5)
g.adiciona_aresta(4, 2, 9)
g.adiciona_aresta(4, 5, 15)
g.adiciona_aresta(4, 6, 6)
g.adiciona_aresta(5, 4, 15)
g.adiciona_aresta(5, 6, 8)
g.adiciona_aresta(5, 7, 9)
g.adiciona_aresta(6, 5, 8)
g.adiciona_aresta(6, 7, 11)
